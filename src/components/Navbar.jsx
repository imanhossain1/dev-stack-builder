        ...
        <div className="navbar sticky top-0 z-50 bg-base-100 shadow-sm">
            ...
            <div className="w-full max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="navbar-end gap-2">
                    ...
                    <a
                        href="#signin"
                        className="btn btn-ghost rounded-full hover:bg-transparent hover:text-orange-500"
                    >
                        Sign In
                    </a>
                    ...
                    <a
                        href="#signup"
                        className="btn rounded-full bg-red-500 border-red-500 text-white hover:bg-red-600"
                    >
                        Sign Up
                    </a>
